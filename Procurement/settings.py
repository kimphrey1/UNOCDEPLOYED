...
SECRET_KEY = "django-insecure-vmgpzev4mpvsr$p@=jlocj5d(lb*g)gty@l$r*cw%shbm$m$k6"
...
# STATICFILES_DIRS = [
#     os.path.join(BASE_DIR, "biddingApp/static")
# ]

# MEDIA_ROOT = os.path.join(BASE_DIR, 'biddingApp/media')
# MEDIA_URL = '/media/'
...
LOGIN_REDIRECT_URL = '/all_notices/'
